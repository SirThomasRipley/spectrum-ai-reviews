...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      description: `${service.description}. Expert analysis and rankings to help you choose the right AI tool.`,
      url: `https://spectrumaireviews.com/${params.service}`,
      siteName: 'SpectrumAIReviews',
      locale: 'en_US',
      type: 'website',
      images: [{
        url: `https://spectrumaireviews.com/images/${params.service}-og.jpg`,
        width: 1200,
        height: 630,
        alt: `${service.name} - Expert Reviews & Comparisons`,
      }],
    },
    twitter: {
      card: 'summary_large_image',
      title: `${service.name} Reviews & Comparisons 2025`,
      description: `${service.description}. Expert analysis and rankings.`,
      images: [`https://spectrumaireviews.com/images/${params.service}-twitter.jpg`],
