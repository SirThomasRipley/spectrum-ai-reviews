...
export const categories = [
  {
    ...
    name: 'Productivity',
    slug: 'productivity',
    description: 'AI tools designed to boost your productivity and streamline workflows.',
  },
  {
    id: 'content-creation',
    name: 'Content Creation',
    slug: 'content-creation',
    description: 'Tools for creating engaging content, from articles to social media posts.',
  },
  {
    id: 'business',
    name: 'Business & Marketing',
    slug: 'business-marketing',
    description: 'AI solutions for business operations, marketing, and customer engagement.',
  },
  {
    id: 'creative',
    name: 'Creative & Design',
    slug: 'creative-design',
    description: 'Creative tools for designers, artists, and visual content creators.',
  },
];
